export default function drinks(state = {
    ...
    myBar:[],
    loading: false,
    barEssentials: { liquors: ["GiIn", "Dark Rum", "Light Rum", "Tequila", "Brandy", "Bourbon", "Rye Whiskey", "Vodka"], liqueurs: ["Sweet Vermouth", "Dry Vermouth", "Amaretto", "Coffee Liqueur", "Orange Liqueur"], mixersGarnishes: ["Club Soda", "Tonic", "Ginger Ale", "Bitters"]},
  }, action) {
